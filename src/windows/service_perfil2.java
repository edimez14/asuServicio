...
public class service_perfil2 extends javax.swing.JFrame {

    public service_perfil2() {
        initComponents();
        this.setLocationRelativeTo(null);

    }

    // Si lo necesitas, puedes modificar otras configuraciones aquí
    ...
    private void jButton_solicitudesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_solicitudesActionPerformed
        Servicio2 verServicio2 = new Servicio2();
        verServicio2.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(service_perfil2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new service_perfil2().setVisible(true);
            }
        });
    }
