 ...
 * @author John Esteban
 */
public class Servicio2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Servicio1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/Bike 300.png"))); // NOI18N
        Servicio1.setContentAreaFilled(false);
        Servicio1.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/Bike 400.png"))); // NOI18N
    ...
    private void jButton_volverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_volverActionPerformed
        service_perfil2 verservice_perfil2 = new service_perfil2();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Servicio2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
