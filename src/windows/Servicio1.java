 ...
 * @author John Esteban
 */
public class Servicio1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Servicio1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/Ambulance 300.png"))); // NOI18N
        Servicio1.setContentAreaFilled(false);
        Servicio1.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/Ambulance 400.png"))); // NOI18N
    ...
    private void jButton_volverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_volverActionPerformed
        service_perfil1 verservice_perfil1 = new service_perfil1();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Servicio1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
